...
\subsection{Transition to operations}

\begin{figure}
\plotone{DpOrg}
\caption{ The operaitons organisation follows the cyber infrastrucutre layout of DM more than the WBS structure of construction.  \label{fig:opsorg}}
\end{figure}
